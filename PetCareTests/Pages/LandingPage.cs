...
namespace PetCareTests.Pages
{
    public class LandingPage
    {
        ...
        public IWebElement LandingHeader => _driver.FindElement(By.XPath("//h1[contains(., 'Pet Business')]"));
        ...
        public string paragraphsText = "Do you live in Wilmette / Kenilworth / Evanston / Skokie / Winnetka? Going on vacation and need someone to take care of your pet? I am here to help. I will come over, feed and take care of your pet, walk and play with them. " + 
	    "You need to be in biking range (2-3 miles) from Lake Ave and Ridge Rd intersection in Wilmette, IL. " + 
